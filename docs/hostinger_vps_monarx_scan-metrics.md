## hostinger vps monarx scan-metrics
...
```
hostinger vps monarx scan-metrics <virtual-machine-id> [flags]
```
...
* [hostinger vps monarx](hostinger_vps_monarx.md)	 - Malware scanner commands
