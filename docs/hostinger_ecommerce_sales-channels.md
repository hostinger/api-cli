## hostinger ecommerce sales-channels

Sales channels commands

### Options

```
  -h, --help   help for sales-channels
```
...
* [hostinger ecommerce sales-channels create](hostinger_ecommerce_sales-channels_create.md)	 - Create a sales channel
