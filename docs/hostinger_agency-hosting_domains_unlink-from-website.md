## hostinger agency-hosting domains unlink-from-website
...
```
hostinger agency-hosting domains unlink-from-website <website_uid> <domain> [flags]
```

### Options

```
  -h, --help   help for unlink-from-website
```
