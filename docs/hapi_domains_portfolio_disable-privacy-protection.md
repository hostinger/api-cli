## hapi domains portfolio disable-privacy-protection
...
```
hapi domains portfolio disable-privacy-protection <domain> [flags]
```

### Options

```
  -h, --help   help for disable-privacy-protection
```
