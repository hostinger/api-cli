## hostinger agency-hosting websites build-nodejs-assets
...
```
hostinger agency-hosting websites build-nodejs-assets <website_uid> [flags]
```
...
```
  ...
  -h, --help                       help for build-nodejs-assets
```
