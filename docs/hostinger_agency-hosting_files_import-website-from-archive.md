## hostinger agency-hosting files import-website-from-archive
...
```
hostinger agency-hosting files import-website-from-archive <website_uid> [flags]
```
...
```
  ...
  -h, --help                  help for import-website-from-archive
```
