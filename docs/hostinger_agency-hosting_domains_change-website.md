## hostinger agency-hosting domains change-website
...
```
hostinger agency-hosting domains change-website <website_uid> <from_domain> [flags]
```
...
```
  ...
  -h, --help            help for change-website
```
