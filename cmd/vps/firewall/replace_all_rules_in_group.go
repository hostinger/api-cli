...
var ReplaceAllRulesInGroupCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		r, err := api.Request().VPSReplaceAllFirewallRulesInGroupV1WithBodyWithResponse(context.TODO(), utils.StringToInt(args[0]), "application/json", bytes.NewReader(payload))
		if err != nil {
			log.Fatal(err)
		}
