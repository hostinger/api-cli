...
var DeleteWebsiteCmd = &cobra.Command{
	Use:   "delete-website <website_uid> <uuid>",
	Short: "Delete website cron job",
	...
	Run: func(cmd *cobra.Command, args []string) {
		r, err := api.Request().AgencyHostingDeleteWebsiteCronJobV1WithResponse(context.TODO(), args[0], uuid.MustParse(args[1]))
		if err != nil {
			log.Fatal(err)
		}
