...
var StatusCmd = &cobra.Command{
	Use:   "status <order_id> <setup_uuid>",
	Short: "Get website setup status",
	...
	Run: func(cmd *cobra.Command, args []string) {
		r, err := api.Request().AgencyHostingGetWebsiteSetupStatusV1WithResponse(context.TODO(), utils.StringToInt(args[0]), uuid.MustParse(args[1]))
		if err != nil {
			log.Fatal(err)
		}
