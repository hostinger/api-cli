...
var UnlinkFromWebsiteCmd = &cobra.Command{
	Use:   "unlink-from-website <website_uid> <domain>",
	Short: "Unlink domain from website",
	...
	Run: func(cmd *cobra.Command, args []string) {
		r, err := api.Request().AgencyHostingUnlinkDomainFromWebsiteV1WithResponse(context.TODO(), args[0], args[1])
		if err != nil {
			log.Fatal(err)
		}
